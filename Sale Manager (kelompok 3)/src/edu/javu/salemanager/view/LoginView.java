...
import edu.javu.salemanager.main.SaleManager;
...
public class LoginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.setBackground(new java.awt.Color(0, 74, 87));
        ...
        jPanel4.setBackground(new java.awt.Color(0, 74, 87));
    ...
    private void btnMasukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMasukActionPerformed
        ...
        if (txtUsername.getText().equals("admin") && txtPassword.getText().equals("12345")) {
            ...
            try {
                SepatuView sepatu = new SepatuView();

                sepatu.loadDatabase();
                sepatu.loadDatabase1();
                sepatu.setVisible(true);
                this.setVisible(false);

            } catch (SQLException e) {
            } catch (SepatuException ex) {
                Logger.getLogger(SaleManager.class.getName()).log(Level.SEVERE, null, ex);
            } catch (PesananException ex) {
                Logger.getLogger(SaleManager.class.getName()).log(Level.SEVERE, null, ex);
            }
